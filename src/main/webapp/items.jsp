<%@ page contentType="text/html;charset=UTF-8" %>
    <%@ page isELIgnored="false" %>
        ...
        <head>
            ...
            <script src="${pageContext.request.contextPath}/js/items.js" defer></script>
        </head>
        ...
        <body>
            ...
            <main class="container">
                ...
                <div class="page-header">
                    ...
                    <div>
                        <p class="page-eyebrow">PRODUCT MANAGEMENT</p>
                ...
                <section class="form-card">
                    ...
                    <div class="section-header">
                        <div>
                            <h2>Add New Item</h2>
                            <p>Enter the item details to create a new product.</p>
                        </div>
                    </div>
                    ...
                    <form id="addItemForm" class="item-form">
                        ...
                        <div class="form-grid">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" id="length" name="length" min="0" step="0.01" value="0" required>
                            </div>

                            <div class="form-group">
                                <label for="width">Width</label>
                                <input type="number" id="width" name="width" min="0" step="0.01" value="0" required>
                            </div>
                ...
                <section class="table-card">
                    ...
                    <div class="section-header">
                        ...
                        <div>
                            <h2>All Items</h2>
                            <p>View and manage products registered in the system.</p>
                        </div>
                ...
                <div class="modal-content">
                    ...
                    <form id="editItemForm">
                        ...
                        <div class="form-grid">
                            ...
                            <div class="form-group">
                                <label>
                                    <input type="checkbox" id="editTrackInventory" name="trackInventory" checked>
                                    Track Inventory
                                </label>
                            </div>
