...
<body>
    ...
    <div class="container">
        ...
        <!-- ONE-CLICK PACK & SHIP -->
        <div class="pack-ship-panel" id="packShipSection">
            <h2>Pack &amp; Ship</h2>

            <p class="pack-ship-help">
                Create a package and shipment for this sales order in one operation.
                The order's items and quantities will be used automatically.
                The destination address is taken from the customer's details, and
                the system uses its default dispatch address and package dimensions.
            </p>

            <div class="pack-ship-fields">
                <div class="form-group">
        ...
        <!-- SHIPPING SECTION -->
        <div id="shippingSection" class="form-section" style="display:none;">
            ...
            <div class="form-group">
                ...
                <div
                    id="selectedPackages"
                    style="padding:12px;background:#f5f7fa;border-radius:8px;"
                ></div>
            </div>
            ...
            <div class="form-section" style="margin-top:20px;">
                ...
                <div class="shipping-rate-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="totalShippingCharge" value="-" class="readonly-input" readonly>
                    </div>
                </div>
    ...
    <!-- JAVASCRIPT -->
    <script src="/erpflow/js/salesOrderDetails.js?v=6" defer></script>
