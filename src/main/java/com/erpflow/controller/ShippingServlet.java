...
public class ShippingServlet extends HttpServlet {
        ...
        protected void doPost(
                ...
                try {
                        ...
                        if ("/rate".equals(path)) {
                                JsonNode packageIdsNode = root.get("packageIds");
                                ...
                                JsonNode carrierServiceNode = root.get("carrierServiceId");
                                ...
                                int carrierServiceId = carrierServiceNode.asInt();

                                ShippingRateService.ShippingRate rate = shippingRateService.calculateRate(
                                                packageIds,
                                                carrierServiceId);
                        ...
                        JsonNode salesOrderNode = root.get("salesOrderId");
                        ...
                        int salesOrderId = salesOrderNode.asInt();
                        ...
                        JsonNode shipmentDateNode = root.get("shipmentDate");
                        ...
                        LocalDate shipmentDate = LocalDate.parse(shipmentDateNode.asText());
